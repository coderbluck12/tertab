            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">View all your withdrawal requests and their status</p>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $withdrawals->total() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $withdrawals->where('status', 'pending')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{ $withdrawals->where('status', 'completed')->count() }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">₦{{ number_format($withdrawals->where('status', 'completed')->sum('amount'), 2) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @forelse($withdrawals as $withdrawal)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">{{ $withdrawal->formatted_amount }}</div>
                                        @if($withdrawal->withdrawal_reason)
                                            <div class="text-xs text-gray-500">{{ Str::limit($withdrawal->withdrawal_reason, 30) }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        @if($withdrawal->processed_date)
                                            ...
                                            <div class="text-xs">{{ $withdrawal->processed_date->format('h:i A') }}</div>
                                        @else
